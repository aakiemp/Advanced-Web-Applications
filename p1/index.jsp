				...
				lname: {
					...
					street: {
							validators: {
									...
									regexp: {
										regexp: /^[a-zA-Z0-9,\-\s\.]+$/,
										message: 'Sreet can only contain letters, numbers, commas, hyphens, or periods'
									},									
							},
					},
					...
					balance: {
							validators: {
									...
									regexp: {
										regexp: /^[0-9\.]+$/,
										message: 'Balance can only contain numbers and decimalpoint'
									},									
							},
					},
					...
					total_sales: {
							validators: {
									...
									stringLength: {
											min: 1,
											max: 7,
											message: 'Total sales con be no more than 6 digits, including decimal point'
									},
									regexp: {
										regexp: /^[0-9\.]+$/,
